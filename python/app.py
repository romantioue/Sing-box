...
config = {
    'UUID': os.environ.get('UUID', '0d38a225-ec44-43a6-a244-95bb75a90110'), # 节点UUID，使用哪吒v1时在不不同的平台部署需要修改，否则agent会覆盖
    ...
    'ARGO_DOMAIN': os.environ.get('ARGO_DOMAIN', 'kata.lulument.kdns.fr'),   # 固定隧道域名,留空即启用临时隧道
    'ARGO_AUTH': os.environ.get('ARGO_AUTH', 'eyJhIjoiODc0ZTFjMTMxNDgzNjkxZDVhMDQ2MjZmMDdhOWI5MmEiLCJ0IjoiOWMwNjM5ODAtYWY4Yy00MTQyLThmODUtYTZjZGNjZmFkZDQ2IiwicyI6Ik16STNZVGsxTjJZdE1UQXlOQzAwWTJWaUxUaGxabUV0Tm1SalkyVTJPV1poTlRjNCJ9'),       # 固定隧道token或json,留空即启用临时隧道,json获取:https://json.zone.id
